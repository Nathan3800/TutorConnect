...
const Star = ({ size = 24, className = "", filled = false, half = false }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
const TutorsPage = () => {
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 0; i < fullStars; i++) {
      stars.push(
        <Star key={i} size={16} className="text-yellow-500" filled={true} />
      );
    }

    if (hasHalfStar) {
      stars.push(
        <Star key="half" size={16} className="text-yellow-500" half={true} />
      );
    }
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredTutors.map((tutor) => (
              ...
              >
                ...
                />
                <div className="p-6">
                  <h5 className="text-xl font-semibold mb-2">{tutor.name}</h5>
                  <p
                    className={`mb-3 ${
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        >
                          {selectedTutor?.subject} • ${selectedTutor?.price}/hr
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-6">
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span>Subject:</span>
                      <span className="font-medium">{bookingForm.subject}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Date & Time:</span>
              ...
              <div className="p-6 text-center">
                ...
                >
                  ...
                  >
                    ...
                    <li>• Your tutor will contact you before the session</li>
                    <li>• Join the session using the link in your email</li>
                  </ul>
                </div>
